...
semester_start = datetime(int(sembegin[0]), int(sembegin[1]), int(sembegin[2]), 0, 0, 0, tzinfo=bjtz)  # Semester starts at

# read from varenv whem compiled into an exe
ynu_ehell_name = input('Ehall Username:')  # Your EHALL SYSTEM Username
ynu_ehell_password = input('Password:')  # Your EHALL SYSTEM Password
